...
#cluster
ruta_bfile <- "/mnt/data/sur/users/spacheco/data/teosinte/filtrado_inicial" 
ruta_metadata <- "/mnt/data/sur/users/spacheco/data/teosinte/data_teosinte.csv"
ruta_carpeta_salida <- "/mnt/data/sur/users/spacheco/results/sep_2026/teo/24_sep/filtrado_3303/"
