...
ruta_salida_geno  <- "/home/sam/Documents/sur_ecoevo_lab/exp/sep_2026/bayescenv/prueba1_02.09.2026/20_random_pob_bayesformato.txt"  # input para bayescenv
ruta_salida_orden <- "/home/sam/Documents/sur_ecoevo_lab/exp/sep_2026/bayescenv/prueba1_02.09.2026/orden_20_random_pop.csv"             # mapping pop_index -> Accession
ruta_salida_diccionario <- file.path(dirname(ruta_salida_geno), "diccionario_alelos_20randompop.csv")

#Deja NULL para correr con las 276 poblaciones completas.
poblaciones_incluir <- c( "CIM27224", "JACV-T-005", "JACV-T-045", "JACV-T-062", "JACV-T-063", "JACV-T-074", "JLNCM-643", "JLVTKV-717", "JSG Y RMM-440-2004", "JSG Y RMM-447-2005", "JSG-JMHC-610", "JSG-JMHC-615", "JSG-JMHC-632", "JSG-LCL-670", "JSG-LCL-677", "LSC-TS-001", "RMM-FJSM-212", "RMM-FJSM-VHRO-224", "RMM-FJSM-VHRO-226", "RMM-VHRO-238" )  
...
write.csv(diccionario_alelos, "diccionario_alelos_20_random_pop.csv", row.names = FALSE)
message("Diccionario de alelos (qué nucleótido es alelo1/alelo2 por locus) guardado en: diccionario_alelos_20_random_pop.csv")
