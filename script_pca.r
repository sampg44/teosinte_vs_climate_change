...
#cluster
ruta_bfile <- "/mnt/data/sur/users/spacheco/data/teosinte/T3604_33929_all" 
ruta_metadata <- "/mnt/data/sur/users/spacheco/data/teosinte/data_teosinte.csv"
ruta_carpeta_salida <- "/mnt/data/sur/users/spacheco/results/sep_2026/teo/24_sep/inicial/"
